...
/***/ "./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./src/formedit/formedit.scss":
/*!*****************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./src/formedit/formedit.scss ***!
  \*****************************************************************************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {
...
main form .form-group #container-photo-label-img {
  display: flex;
  justify-content: space-between;
}
@media (max-width: 480px) {
...
main form .form-group #container-photo-label-img #container-photo-label {
  display: flex;
  flex-direction: column;
  justify-content: space-evenly;
}
@media (max-width: 480px) {
  main form .form-group #container-photo-label-img #container-photo-img {
    margin-top: 1rem;
    margin-left: auto;
    margin-right: auto;
  }
...
main form .form-group #container-photo-label-img #container-photo-img img {
  padding: 0.5rem;
  box-shadow: var(--shadow);
}
main form .form-group label,
main form .form-group #div-content {
  font-size: 1.8rem;
  color: var(--dark);
  font-weight: 700;
  margin-bottom: 1rem;
...
#shallow-content-value p {
  font-family: var(--form);
  font-size: 1.3rem;
}
#shallow-content-value p span {
  font-style: italic;
  font-size: 1.2 rem;
  font-weight: bold;
  color: var(--primary);
...
.input-category-definition span {
  color: var(--primary);
}

.text-definition-guide,
.text-definition-quete,
...
#container-photographer #container-photographer-label-img {
  display: flex;
  flex-direction: column;
}
@media (max-width: 480px) {
...
#container-photographer #container-photographer-label-img #container-photographer-label {
  display: flex;
  justify-content: space-between;
}
@media (max-width: 480px) {
...
#container-photographer #container-photographer-label-img #container-photographer-label label {
  display: flex;
  justify-content: center;
  align-items: center;
}
#container-photographer #container-photographer-label-img #container-img-description-photographer {
  display: flex;
...
#container-photographer #container-photographer-label-img #container-img-description-photographer #container-description-photographer {
  width: 30rem;
  padding: 0.5rem;
  margin-top: -0.5rem;
}
...
#container-photographer #container-photographer-label-img #container-img-description-photographer #container-description-photographer p {
  margin-top: 4rem;
  font-size: 1.3rem;
}
@media (max-width: 480px) {
...
#container-photographer #container-photographer-label-img #container-img-description-photographer #container-description-photographer p span {
  color: var(--primary);
  font-weight: bold;
}
#container-photographer #container-photographer-label-img .container-user-img {
  width: 50%;
  display: flex;
  justify-content: center;
  align-items: center;
}
#container-photographer #container-photographer-label-img .container-user-img img {
  height: 13rem;
  width: 15rem;
  padding: 0.3rem;
  box-shadow: var(--shadow);
...
.text-danger {
  color: var(--danger);
}`, "",{"version":3,"sources":["webpack://./src/formedit/formedit.scss","webpack://./src/assets/sass/partials/_media-queries.scss"],"names":[],"mappings":"AAEA;EACE,gCAAA;AADF;;AAIA;EACE,aAAA;EACA,uBAAA;EACA,mBAAA;AADF;AAEE;EACE,iBAAA;EACA,oBAAA;EACA,gBAAA;EACA,WAAA;EACA,aAAA;EACA,yBAAA;EACA,qBAAA;EACA,aAAA;EACA,sBAAA;AAAJ;AClBE;EDSA;IAWI,gBAAA;IACA,aAAA;EAEJ;AACF;AADI;EACE,aAAA;EACA,uBAAA;EACA,mBAAA;EACA,mBAAA;AAGN;AADI;EACE,mBAAA;EACA,aAAA;EACA,sBAAA;AAGN;AAFM;EACE,aAAA;EACA,8BAAA;AAIR;ACvCE;EDiCI;IAII,aAAA;IACA,sBAAA;EAMR;AACF;ACvCE;ED2BI;IAQI,aAAA;IACA,sBAAA;EAQR;AACF;AAPQ;EACE,aAAA;EACA,sBAAA;EACA,6BAAA;AASV;ACxDE;EDiDM;IAEI,gBAAA;IACA,iBAAA;IACA,kBAAA;EASV;AACF;ACzDE;ED2CM;IAOI,gBAAA;IACA,iBAAA;IACA,kBAAA;EAWV;AACF;AAVU;EACE,eAAA;EACA,yBAAA;AAYZ;AARM;;EAEE,iBAAA;EACA,kBAAA;EACA,gBAAA;EACA,mBAAA;AAUR;AARM;EACE,mCAAA;EACA,aAAA;EACA,aAAA;EACA,qBAAA;EACA,eAAA;AAUR;AATQ;EACE,4BAAA;AAWV;AARM;EACE,YAAA;EACA,iBAAA;EACA,mCAAA;EACA,eAAA;EACA,aAAA;EACA,qBAAA;EACA,yBAAA;AAUR;ACpGE;EDmFI;IASI,YAAA;EAYR;AACF;AAXQ;EACE,4BAAA;AAaV;AATI;EACE,mBAAA;EACA,aAAA;EACA,sBAAA;AAWN;AAVM;EACE,aAAA;EACA,mBAAA;EACA,iBAAA;EACA,6BAAA;EACA,gBAAA;EACA,mCAAA;EACA,aAAA;EACA,aAAA;EACA,qBAAA;EACA,eAAA;AAYR;AAXQ;EACE,4BAAA;AAaV;AATI;EACE,aAAA;EACA,aAAA;EACA,sBAAA;EACA,YAAA;EACA,wBAAA;AAWN;AATI;EACE,aAAA;EACA,yBAAA;EACA,mBAAA;AAWN;AAVM;EACE,iBAAA;EACA,oBAAA;AAYR;;AALA;EACE,gBAAA;EACA,gCAAA;EACA,sBAAA;EACA,aAAA;EACA,WAAA;EACA,aAAA;EACA,sBAAA;AAQF;AAPE;EACE,wBAAA;EACA,iBAAA;AASJ;AARI;EACE,kBAAA;EACA,kBAAA;EACA,iBAAA;EACA,qBAAA;AAUN;;AANA;EACE,aAAA;EACA,WAAA;EACA,aAAA;EACA,sBAAA;EACA,YAAA;EACA,wBAAA;EACA,gBAAA;AASF;;AANA;EACE,kBAAA;EACA,iBAAA;AASF;AARE;EACE,qBAAA;AAUJ;;AANA;;;;EAIE,iBAAA;EACA,qBAAA;AASF;;AANA;EACE,mBAAA;EACA,oBAAA;AASF;;AANA;EACE,aAAA;EACA,sBAAA;AASF;;AANA;EACE,cAAA;EACA,mBAAA;AASF;;AALA;EACE,mBAAA;AAQF;AAPE;EACE,aAAA;EACA,sBAAA;AASJ;ACrNE;ED0MA;IAII,aAAA;EAWJ;AACF;AAVI;EACE,aAAA;EACA,8BAAA;AAYN;AC9NE;EDgNE;IAII,aAAA;IACA,sBAAA;IACA,qBAAA;EAcN;AACF;AAbM;EACE,aAAA;EACA,uBAAA;EACA,mBAAA;AAeR;AAZI;EACE,aAAA;EACA,2BAAA;EACA,8BAAA;AAcN;AC/OE;ED8NE;IAKI,aAAA;IACA,sBAAA;IACA,mBAAA;EAgBN;AACF;AAfM;EACE,YAAA;EACA,eAAA;EACA,mBAAA;AAiBR;AC3PE;EDuOI;IAKI,WAAA;EAmBR;AACF;AAlBQ;EACE,gBAAA;EACA,iBAAA;AAoBV;ACpQE;ED8OM;IAII,gBAAA;IACA,YAAA;IACA,iBAAA;IACA,kBAAA;EAsBV;AACF;AArBU;EACE,qBAAA;EACA,iBAAA;AAuBZ;AAlBI;EACE,UAAA;EACA,aAAA;EACA,uBAAA;EACA,mBAAA;AAoBN;AAnBM;EACE,aAAA;EACA,YAAA;EACA,eAAA;EACA,yBAAA;AAqBR;;AAfA;EACE,iBAAA;EACA,kBAAA;EACA,gBAAA;EACA,mBAAA;AAkBF;;AAfA;EACE,oBAAA;EACA,gBAAA;EACA,gBAAA;AAkBF;;AAfA;EACE,oBAAA;EACA,gBAAA;EACA,iBAAA;EACA,mBAAA;AAkBF;;AAfA;EACE,oBAAA;AAkBF","sourcesContent":["@use \"../assets/sass/partials/media-queries\" as *;\n\n.header-nav {\n  padding: 0.5rem 1rem 0.5rem 1rem;\n}\n\nmain {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  form {\n    margin-top: 20rem;\n    margin-bottom: 20rem;\n    max-width: 70rem;\n    width: 100%;\n    padding: 4rem;\n    box-shadow: var(--shadow);\n    border-radius: 0.3rem;\n    display: flex;\n    flex-direction: column;\n    @include phone {\n      max-width: 37rem;\n      padding: 1rem;\n    }\n    h2 {\n      display: flex;\n      justify-content: center;\n      align-items: center;\n      margin-bottom: 5rem;\n    }\n    .form-group {\n      margin-bottom: 5rem;\n      display: flex;\n      flex-direction: column;\n      #container-photo-label-img {\n        display: flex;\n        justify-content: space-between;\n        @include phone {\n          display: flex;\n          flex-direction: column;\n        }\n        @include tablet {\n          display: flex;\n          flex-direction: column;\n        }\n        #container-photo-label {\n          display: flex;\n          flex-direction: column;\n          justify-content: space-evenly;\n        }\n        #container-photo-img {\n          @include phone {\n            margin-top: 1rem;\n            margin-left: auto;\n            margin-right: auto;\n          }\n          @include tablet {\n            margin-top: 1rem;\n            margin-left: auto;\n            margin-right: auto;\n          }\n          img {\n            padding: 0.5rem;\n            box-shadow: var(--shadow);\n          }\n        }\n      }\n      label,\n      #div-content {\n        font-size: 1.8rem;\n        color: var(--dark);\n        font-weight: 700;\n        margin-bottom: 1rem;\n      }\n      input {\n        border: 0.1rem solid var(--divider);\n        padding: 1rem;\n        outline: none;\n        border-radius: 0.3rem;\n        cursor: default;\n        &:focus {\n          border-color: var(--primary);\n        }\n      }\n      select {\n        height: 4rem;\n        font-size: 1.4rem;\n        border: 0.1rem solid var(--divider);\n        padding: 0.5rem;\n        outline: none;\n        border-radius: 0.3rem;\n        font-family: var(--basic);\n        @include phone {\n          width: 35rem;\n        }\n        &:focus {\n          border-color: var(--primary);\n        }\n      }\n    }\n    .form-category {\n      margin-bottom: 5rem;\n      display: flex;\n      flex-direction: column;\n      .container-name-category {\n        display: flex;\n        flex-direction: row;\n        font-size: 1.4rem;\n        justify-content: space-evenly;\n        margin-top: 1rem;\n        border: 0.1rem solid var(--divider);\n        padding: 1rem;\n        outline: none;\n        border-radius: 0.3rem;\n        cursor: default;\n        &:focus {\n          border-color: var(--primary);\n        }\n      }\n    }\n    textarea {\n      height: 12rem;\n      padding: 1rem;\n      letter-spacing: 0.1rem;\n      resize: none;\n      font-family: var(--form);\n    }\n    .form-button-container {\n      display: flex;\n      justify-content: flex-end;\n      align-items: center;\n      .button {\n        margin-left: 1rem;\n        margin-right: 0.2rem;\n      }\n    }\n  }\n}\n\n// js start //\n#shallow-content-value {\n  margin-top: 1rem;\n  border: 0.1rem solid var(--dark);\n  border-radius: 0.25rem;\n  height: 12rem;\n  width: 100%;\n  padding: 1rem;\n  letter-spacing: 0.1rem;\n  p {\n    font-family: var(--form);\n    font-size: 1.3rem;\n    span {\n      font-style: italic;\n      font-size: 1.2 rem;\n      font-weight: bold;\n      color: var(--primary);\n    }\n  }\n}\n.content-note {\n  height: 15rem;\n  width: 100%;\n  padding: 1rem;\n  letter-spacing: 0.1rem;\n  resize: none;\n  font-family: var(--form);\n  font-weight: 100;\n}\n\n.input-category-definition {\n  font-style: italic;\n  font-weight: bold;\n  span {\n    color: var(--primary);\n  }\n}\n\n.text-definition-guide,\n.text-definition-quete,\n.text-definition-collection,\n.text-definition-partage {\n  font-weight: bold;\n  color: var(--primary);\n}\n\n.text-definition-padding {\n  padding-top: 0.5rem;\n  padding-left: 0.5rem;\n}\n\n.flex-column {\n  display: flex;\n  flex-direction: column;\n}\n\n.width-select-photographer {\n  width: 31.5rem;\n  margin-bottom: 1rem;\n}\n// js end //\n\n#container-photographer {\n  margin-bottom: 5rem;\n  #container-photographer-label-img {\n    display: flex;\n    flex-direction: column;\n    @include phone {\n      display: flex;\n    }\n    #container-photographer-label {\n      display: flex;\n      justify-content: space-between;\n      @include phone {\n        display: flex;\n        flex-direction: column;\n        align-items: baseline;\n      }\n      label {\n        display: flex;\n        justify-content: center;\n        align-items: center;\n      }\n    }\n    #container-img-description-photographer {\n      display: flex;\n      flex-direction: row-reverse;\n      justify-content: space-between;\n      @include phone {\n        display: flex;\n        flex-direction: column;\n        align-items: center;\n      }\n      #container-description-photographer {\n        width: 30rem;\n        padding: 0.5rem;\n        margin-top: -0.5rem;\n        @include phone {\n          width: auto;\n        }\n        p {\n          margin-top: 4rem;\n          font-size: 1.3rem;\n          @include phone {\n            margin-top: 1rem;\n            width: 35rem;\n            margin-left: auto;\n            margin-right: auto;\n          }\n          span {\n            color: var(--primary);\n            font-weight: bold;\n          }\n        }\n      }\n    }\n    .container-user-img {\n      width: 50%;\n      display: flex;\n      justify-content: center;\n      align-items: center;\n      img {\n        height: 13rem;\n        width: 15rem;\n        padding: 0.3rem;\n        box-shadow: var(--shadow);\n      }\n    }\n  }\n}\n\n.form-title-category {\n  font-size: 1.8rem;\n  color: var(--dark);\n  font-weight: 700;\n  margin-bottom: 1rem;\n}\n\n#text-info-content {\n  color: var(--danger);\n  font-weight: 700;\n  margin-top: 1rem;\n}\n\n#text-info {\n  color: var(--danger);\n  font-weight: 700;\n  margin-top: -2rem;\n  margin-bottom: 2rem;\n}\n\n.text-danger {\n  color: var(--danger);\n}\n","@mixin phone {\n  @media (max-width: 480px) {\n    @content;\n  }\n}\n\n@mixin tablet {\n  @media (min-width: 481px) and (max-width: 767px) {\n    @content;\n  }\n}\n\n@mixin laptop {\n  @media (min-width: 768px) and (max-width: 1199px) {\n    @content;\n  }\n}\n\n@mixin computer {\n  @media (min-width: 1200px) {\n    @content;\n  }\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
/* harmony import */ var _node_modules_style_loader_dist_runtime_styleTagTransform_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! !../../node_modules/style-loader/dist/runtime/styleTagTransform.js */ "./node_modules/style-loader/dist/runtime/styleTagTransform.js");
/* harmony import */ var _node_modules_style_loader_dist_runtime_styleTagTransform_js__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_node_modules_style_loader_dist_runtime_styleTagTransform_js__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_node_modules_sass_loader_dist_cjs_js_formedit_scss__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! !!../../node_modules/css-loader/dist/cjs.js!../../node_modules/sass-loader/dist/cjs.js!./formedit.scss */ "./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./src/formedit/formedit.scss");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_node_modules_sass_loader_dist_cjs_js_formedit_scss__WEBPACK_IMPORTED_MODULE_6__["default"], options);




       /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_css_loader_dist_cjs_js_node_modules_sass_loader_dist_cjs_js_formedit_scss__WEBPACK_IMPORTED_MODULE_6__["default"] && _node_modules_css_loader_dist_cjs_js_node_modules_sass_loader_dist_cjs_js_formedit_scss__WEBPACK_IMPORTED_MODULE_6__["default"].locals ? _node_modules_css_loader_dist_cjs_js_node_modules_sass_loader_dist_cjs_js_formedit_scss__WEBPACK_IMPORTED_MODULE_6__["default"].locals : undefined);
...
/* harmony import */ var _formedit_scss__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./formedit.scss */ "./src/formedit/formedit.scss");
/* harmony import */ var _assets_javascripts_link_js__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ../assets/javascripts/link.js */ "./src/assets/javascripts/link.js");
...
var inputCategoryGuide = document.querySelector("#Guide");
var inputCategoryQuete = document.querySelector("#Quête");
var inputCategoryCollection = document.querySelector("#Collection");
var inputCategoryPartage = document.querySelector("#Partage");
var containerDescriptionCategory = document.querySelector("#container-description-category");
var textDefinitionGuide = document.querySelector(".text-definition-guide");
var textDefinitionQuete = document.querySelector(".text-definition-quete");
var textDefinitionCollection = document.querySelector(".text-definition-collection");
var textDefinitionPartage = document.querySelector(".text-definition-partage");
...
var containerPhotographerLabel = document.querySelector("#container-photographer-label");
var containerDescriptionPhotographer = document.querySelector("#container-description-photographer");
...
var fillForm = function fillForm(formPhoto) {
  ...
  var shallowContentValue = document.querySelector("#shallow-content-value");
  var content = document.querySelector("textarea");
  var selectOptionPicture = picture.querySelector("optgroup > option[value = \"".concat(formPhoto.picture, "\"]"));
  var selectOptionPhotographer = photographer.querySelector("optgroup > option[value = \"".concat(formPhoto.photographer, "\"]"));
  selectOptionPicture.setAttribute("selected", "".concat(formPhoto.photo));
  category.value = formPhoto.category;
  category.setAttribute("checked", "".concat(formPhoto.category));
  selectOptionPhotographer.setAttribute("selected", "".concat(formPhoto.photographer));
  shallowContentValue.innerHTML = "<p> ".concat(formPhoto.content, " <span>(Cliquez ici pour modifier le contenu textuel)</span></p>");
    ...
    case "Guide":
      {
        ...
        containerDescriptionCategory.innerHTML = "<small class=\"input-category-definition\"> <span>*</span>La cat\xE9gorie <span>Guide</span> regroupe les photos prises lors d'un guide touristique. </small>";
        break;
      }
    case "Quête":
      {
        ...
        textDefinitionPartage.classList.add("off");
        containerDescriptionCategory.classList.add("text-definition-padding");
        containerDescriptionCategory.innerHTML = "<small class=\"input-category-definition\"> <span>*</span>La cat\xE9gorie <span>Qu\xEAte</span> regroupe les photos qui sont les r\xE9sultat d'un objectif qui a \xE9t\xE9 atteint. </small>";
        break;
      }
    case "Collection":
      {
        ...
        textDefinitionPartage.classList.add("off");
        containerDescriptionCategory.classList.add("text-definition-padding");
        containerDescriptionCategory.innerHTML = "<small class=\"input-category-definition\"> <span>*</span>La cat\xE9gorie <span>Collection</span> regroupe les photos d'un moment in\xE9dit. </small>";
        break;
      }
    case "Partage":
      {
        ...
        textDefinitionCollection.classList.add("off");
        containerDescriptionCategory.classList.add("text-definition-padding");
        containerDescriptionCategory.innerHTML = "<small class=\"input-category-definition\"> <span>*</span>La cat\xE9gorie <span>Partage</span> regroupe les photos qui sont neutres mais bon \xE0 montrer. </small>";
        break;
      }
  }
  switch (formPhoto.photographer) {
    case "Gustave - L'Aventurier":
      {
        containerDescriptionPhotographer.innerHTML = "<p><span>".concat(_assets_javascripts_link_js__WEBPACK_IMPORTED_MODULE_23__.usersArray[0].photographer.slice(0, 7), "</span> ").concat(_assets_javascripts_link_js__WEBPACK_IMPORTED_MODULE_23__.usersArray[0].profile, " </p>");
        break;
      }
    case "Julie - L'Aventurière":
      {
        containerDescriptionPhotographer.innerHTML = "<p><span>".concat(_assets_javascripts_link_js__WEBPACK_IMPORTED_MODULE_23__.usersArray[1].photographer.slice(0, 5), "</span> ").concat(_assets_javascripts_link_js__WEBPACK_IMPORTED_MODULE_23__.usersArray[1].profile, " </p>");
        break;
      }
    case "Henry - L'Aventurier":
      {
        containerDescriptionPhotographer.innerHTML = "<p><span>".concat(_assets_javascripts_link_js__WEBPACK_IMPORTED_MODULE_23__.usersArray[2].photographer.slice(0, 5), "</span> ").concat(_assets_javascripts_link_js__WEBPACK_IMPORTED_MODULE_23__.usersArray[2].profile, " </p>");
        break;
      }
    case "Zoé - L'Aventurière":
      {
        containerDescriptionPhotographer.innerHTML = "<p><span>".concat(_assets_javascripts_link_js__WEBPACK_IMPORTED_MODULE_23__.usersArray[3].photographer.slice(0, 3), "</span> ").concat(_assets_javascripts_link_js__WEBPACK_IMPORTED_MODULE_23__.usersArray[3].profile, " </p>");
        break;
      }
    case "Flora - L'Exploratrice":
      {
        containerDescriptionPhotographer.innerHTML = "<p><span>".concat(_assets_javascripts_link_js__WEBPACK_IMPORTED_MODULE_23__.usersArray[4].photographer.slice(0, 5), "</span> ").concat(_assets_javascripts_link_js__WEBPACK_IMPORTED_MODULE_23__.usersArray[4].profile, " </p>");
        break;
      }
    case "Denver - L'Explorateur":
      {
        containerDescriptionPhotographer.innerHTML = "<p><span>".concat(_assets_javascripts_link_js__WEBPACK_IMPORTED_MODULE_23__.usersArray[5].photographer.slice(0, 6), "</span> ").concat(_assets_javascripts_link_js__WEBPACK_IMPORTED_MODULE_23__.usersArray[5].profile, " </p>");
        break;
      }
    case "Inaya - L'Exploratrice":
      {
        containerDescriptionPhotographer.innerHTML = "<p><span>".concat(_assets_javascripts_link_js__WEBPACK_IMPORTED_MODULE_23__.usersArray[6].photographer.slice(0, 5), "</span> ").concat(_assets_javascripts_link_js__WEBPACK_IMPORTED_MODULE_23__.usersArray[6].profile, "</p>");
        break;
      }
    case "Seth - L'Explorateur":
      {
        containerDescriptionPhotographer.innerHTML = "<p><span>".concat(_assets_javascripts_link_js__WEBPACK_IMPORTED_MODULE_23__.usersArray[7].photographer.slice(0, 4), "</span> ").concat(_assets_javascripts_link_js__WEBPACK_IMPORTED_MODULE_23__.usersArray[7].profile, "</p>");
        break;
      }
    case "Lance - Le Visiteur":
      {
        containerDescriptionPhotographer.innerHTML = "<p><span>".concat(_assets_javascripts_link_js__WEBPACK_IMPORTED_MODULE_23__.usersArray[8].photographer.slice(0, 5), "</span> ").concat(_assets_javascripts_link_js__WEBPACK_IMPORTED_MODULE_23__.usersArray[8].profile, "</p>");
        break;
      }
    case "Nadia - La Visiteuse":
      {
        containerDescriptionPhotographer.innerHTML = "<p><span>".concat(_assets_javascripts_link_js__WEBPACK_IMPORTED_MODULE_23__.usersArray[9].photographer.slice(0, 5), "</span> ").concat(_assets_javascripts_link_js__WEBPACK_IMPORTED_MODULE_23__.usersArray[9].profile, "</p>");
        break;
      }
    case "Xavier - Le Visiteur":
      {
        containerDescriptionPhotographer.innerHTML = "<p><span>".concat(_assets_javascripts_link_js__WEBPACK_IMPORTED_MODULE_23__.usersArray[10].photographer.slice(0, 6), "</span> ").concat(_assets_javascripts_link_js__WEBPACK_IMPORTED_MODULE_23__.usersArray[10].profile, "</p>");
        break;
      }
    case "Ornella - La Visiteuse":
      {
        containerDescriptionPhotographer.innerHTML = "<p><span>".concat(_assets_javascripts_link_js__WEBPACK_IMPORTED_MODULE_23__.usersArray[11].photographer.slice(0, 7), "</span> ").concat(_assets_javascripts_link_js__WEBPACK_IMPORTED_MODULE_23__.usersArray[11].profile, "</p>");
        break;
      }
    case "Cerise - La Voyageuse":
      {
        containerDescriptionPhotographer.innerHTML = "<p><span>".concat(_assets_javascripts_link_js__WEBPACK_IMPORTED_MODULE_23__.usersArray[12].photographer.slice(0, 6), "</span> ").concat(_assets_javascripts_link_js__WEBPACK_IMPORTED_MODULE_23__.usersArray[12].profile, "</p>");
        break;
      }
    case "Philibert - Le Voyageur":
      {
        containerDescriptionPhotographer.innerHTML = "<p><span>".concat(_assets_javascripts_link_js__WEBPACK_IMPORTED_MODULE_23__.usersArray[13].photographer.slice(0, 9), "</span> ").concat(_assets_javascripts_link_js__WEBPACK_IMPORTED_MODULE_23__.usersArray[13].profile, "</p>");
        break;
      }
    case "Roxane - La Voyageuse":
      {
        containerDescriptionPhotographer.innerHTML = "<p><span>".concat(_assets_javascripts_link_js__WEBPACK_IMPORTED_MODULE_23__.usersArray[14].photographer.slice(0, 6), "</span> ").concat(_assets_javascripts_link_js__WEBPACK_IMPORTED_MODULE_23__.usersArray[14].profile, "</p>");
        break;
      }
    case "Yuu - Le Voyageur":
      {
        containerDescriptionPhotographer.innerHTML = "<p><span>".concat(_assets_javascripts_link_js__WEBPACK_IMPORTED_MODULE_23__.usersArray[15].photographer.slice(0, 3), "</span> ").concat(_assets_javascripts_link_js__WEBPACK_IMPORTED_MODULE_23__.usersArray[15].profile, "</p>");
        break;
      }
  }
};
var initForm = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var response, formPhoto, containerPhotoImg, formPhotoImg, selectPicture, _containerPhotographerImg, formPhotographerImg, _selectPhotographer;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 7:
          ...
          fillForm(formPhoto);
          containerPhotoImg = document.querySelector("#container-photo-img");
          ...
          _context.next = _context.t0 === "Un Désert en Cisjordanie" ? 15 : _context.t0 === "Un Désert en Jordanie" ? 17 : _context.t0 === "Un Désert au Maroc" ? 19 : _context.t0 === "Un Désert en Namibie (Océan Atlantique)" ? 21 : _context.t0 === "Un Désert en Oman" ? 23 : _context.t0 === "Un Désert au Pérou" ? 25 : _context.t0 === "Un Désert en Arabie Saoudite" ? 27 : _context.t0 === "Un Désert en Namibie (Sud-Ouest)" ? 29 : _context.t0 === "Le Désert du Sahara (Soir)" ? 31 : _context.t0 === "Sable Blanc du Nouveau-Mexique (USA)" ? 33 : _context.t0 === "Une Forêt en Australie" ? 35 : _context.t0 === "Une Forêt au Canada" ? 37 : _context.t0 === "Une Forêt en Finlande" ? 39 : _context.t0 === "Une Forêt en Croatie" ? 41 : _context.t0 === "Une Forêt en Inde" ? 43 : _context.t0 === "Une Forêt en Italie" ? 45 : _context.t0 === "Une Forêt au Japon" ? 47 : _context.t0 === "La Forêt des Loups" ? 49 : _context.t0 === "Une Forêt au Nouvelle-Zélande" ? 51 : _context.t0 === "Une Forêt en Washington (USA)" ? 53 : _context.t0 === "Une Plage en Australie" ? 55 : _context.t0 === "Une Plage au Brésil" ? 57 : _context.t0 === "Une Plage en Grande-Bretagne" ? 59 : _context.t0 === "Une Plage en Italie" ? 61 : _context.t0 === "Une Plage en Madagascar" ? 63 : _context.t0 === "Une Plage au Mexique" ? 65 : _context.t0 === "Une Plage en Nouvelle-Calédonie" ? 67 : _context.t0 === "Une Plage en Polynésie Française" ? 69 : _context.t0 === "Une Plage aux Sychelles" ? 71 : _context.t0 === "Une Plage en Thaïlande" ? 73 : _context.t0 === "Une Ville au Chili" ? 75 : _context.t0 === "Une Ville en Chine" ? 77 : _context.t0 === "Une Ville en Colombie" ? 79 : _context.t0 === "Une Ville en France" ? 81 : _context.t0 === "Une Ville en Grande-Bretagne" ? 83 : _context.t0 === "Une Ville au Japon (Jour)" ? 85 : _context.t0 === "Une Ville en Koweït" ? 87 : _context.t0 === "Une Ville en Norvège" ? 89 : _context.t0 === "Une Ville Rural d'Allemagne" ? 91 : _context.t0 === "Une Ville d'Italie (Soir)" ? 93 : 95;
          break;
        case 15:
        ...
        case 95:
          ...
          inputCategoryGuide.addEventListener("input", function (event) {
            event.stopPropagation();
            textDefinitionGuide.classList.remove("off");
            textDefinitionQuete.classList.add("off");
            textDefinitionCollection.classList.add("off");
          ...
          inputCategoryQuete.addEventListener("click", function (event) {
            event.stopPropagation();
            textDefinitionQuete.classList.remove("off");
            textDefinitionGuide.classList.add("off");
            textDefinitionCollection.classList.add("off");
          ...
          inputCategoryCollection.addEventListener("click", function (event) {
            event.stopPropagation();
            textDefinitionCollection.classList.remove("off");
            textDefinitionGuide.classList.add("off");
            textDefinitionQuete.classList.add("off");
          ...
          inputCategoryPartage.addEventListener("click", function (event) {
            event.stopPropagation();
            textDefinitionPartage.classList.remove("off");
            textDefinitionGuide.classList.add("off");
            textDefinitionQuete.classList.add("off");
          ...
          _containerPhotographerImg = document.querySelector("#container-photographer-img");
          _containerPhotographerImg.innerHTML = "<img src=\"".concat(formPhoto.photographer, "\" alt=\"").concat(formPhoto.photographer, "\"  />");
          formPhotographerImg = _containerPhotographerImg.querySelector("img");
          _context.t1 = formPhoto.photographer;
          _context.next = _context.t1 === "Gustave - L'Aventurier" ? 107 : _context.t1 === "Julie - L'Aventurière" ? 109 : _context.t1 === "Henry - L'Aventurier" ? 111 : _context.t1 === "Zoé - L'Aventurière" ? 113 : _context.t1 === "Flora - L'Exploratrice" ? 115 : _context.t1 === "Denver - L'Explorateur" ? 117 : _context.t1 === "Inaya - L'Exploratrice" ? 119 : _context.t1 === "Seth - L'Explorateur" ? 121 : _context.t1 === "Lance - Le Visiteur" ? 123 : _context.t1 === "Nadia - La Visiteuse" ? 125 : _context.t1 === "Xavier - Le Visiteur" ? 127 : _context.t1 === "Ornella - La Visiteuse" ? 129 : _context.t1 === "Cerise - La Voyageuse" ? 131 : _context.t1 === "Philibert - Le Voyageur" ? 133 : _context.t1 === "Roxane - La Voyageuse" ? 135 : _context.t1 === "Yuu - Le Voyageur" ? 137 : 139;
          break;
        case 107:
        ...
        case 137:
          ...
          return _context.abrupt("break", 139);
        case 139:
          _selectPhotographer = document.querySelector("select[name='photographer']");
          _selectPhotographer.addEventListener("change", function (event) {
...
buttonCancel.addEventListener("click", /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(event) {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
          return (0,_assets_javascripts_link_js__WEBPACK_IMPORTED_MODULE_23__.openModal)("Si vous <span class=\"text-detail\">annuler</span>, la <span class=\"text-bold\">Photo</span> ne sera pas <span class=\"text-bold\">modifi\xE9</span>, voulez-vous poursuivre ?");
        case 2:
          result = _context3.sent;
          if (result === true) {
            event.stopPropagation();
            location.assign("./formdetail.html?id=".concat(photoId));
          }
        case 4:
        case "end":
...
/******/ })()
;
//# sourceMappingURL=formedit.bundle.js.map