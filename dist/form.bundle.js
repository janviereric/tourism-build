...
selectContent.addEventListener("change", function (event) {
  ...
  if (contentValue) {
    containerDescriptionNote.innerHTML = "<div id=\"shallow-content-value\"><p> ".concat(contentValue, " <span>(Cliquez ici pour modifier le contenu textuel comme vous voulez)</span></p></div>");
