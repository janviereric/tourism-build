...
.container-bottom-menu .container-categories-menu ul {
  display: flex;
...
/* harmony import */ var _assets_javascripts_link_js__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./assets/javascripts/link.js */ "./src/assets/javascripts/link.js");
...
var guideMenu = categoriesMenu.querySelector("#guide-menu");
var queteMenu = categoriesMenu.querySelector("#quete-menu");
var collectionMenu = categoriesMenu.querySelector("#collection-menu");
var partageMenu = categoriesMenu.querySelector("#partage-menu");
var guideMenuTotal = categoriesMenu.querySelector("#guide-menu-total");
var queteMenuTotal = categoriesMenu.querySelector("#quete-menu-total");
var collectionMenuTotal = categoriesMenu.querySelector("#collection-menu-total");
var partageMenuTotal = categoriesMenu.querySelector("#partage-menu-total");

////////////////////////////// home start //////////////////////////////
var displayHomePhotos = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var homePhotosElement;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          try {
            homePhotosElement = _assets_javascripts_link_js__WEBPACK_IMPORTED_MODULE_26__.homePhotosArray.filter(function (homePhoto) {
              if (filter) {
                return homePhoto.category === filter;
              } else {
                return true;
              }
            }).map(function (homePhoto, index) {
  ...
  return function displayHomePhotos() {
    return _ref.apply(this, arguments);
  };
}();
var createHomePhotosElement = function createHomePhotosElement(homePhoto) {
  var homePhotoContainer = document.createElement("div");
  homePhotoContainer.classList.add("home-photo-container");
  homePhotoContainer.innerHTML = "\n  <img src=\"".concat(homePhoto.photoSrc, "\" alt=\"").concat(homePhoto.picture, "\" />\n    <h2>").concat(homePhoto.picture, "</h2>\n  ");
  var homePhotoImg = homePhotoContainer.querySelector("img");
  homePhotoImg.setAttribute("data-id", "".concat(homePhoto._id));
  homePhotoContainer.addEventListener("click", function (event) {
...
var createMenuCategoriesHome = function createMenuCategoriesHome() {
  var categoriesHome = _assets_javascripts_link_js__WEBPACK_IMPORTED_MODULE_26__.homePhotosArray.reduce(function (acc, homePhoto) {
  ...
  guideMenu.innerText = "Guide (".concat(categoriesHome.Guide, ")");
  queteMenu.innerText = "Qu\xEAte (".concat(categoriesHome.Quête, ")");
  collectionMenu.innerText = "Collection (".concat(categoriesHome.Collection, ")");
  partageMenu.innerText = "Partage (".concat(categoriesHome.Partage, ")");
};
createMenuCategoriesHome();
////////////////////////////// home start //////////////////////////////

////////////////////////////// form start //////////////////////////////
var createFormPhotosElement = function createFormPhotosElement() {
  var formPhotosElement = formPhotos.filter(function (formPhoto) {
    if (filter) {
      return formPhoto.category === filter;
    } else {
      return true;
    }
  }).map(function (formPhoto) {
    var formPhotoContainer = document.createElement("div");
    formPhotoContainer.classList.add("form-photo-container");
    formPhotoContainer.innerHTML = "\n    <img alt=\"".concat(formPhoto.picture, "\" />\n    <h2>").concat(formPhoto.picture, "</h2>");
    var formPhotoImg = formPhotoContainer.querySelector("img");
    formPhotoImg.setAttribute("data-id", "".concat(formPhoto._id));
    formPhotoContainer.addEventListener("click", function (event) {
      var target = event.target;
...
var createMenuCategories = function createMenuCategories() {
  ...
  var categoriesForm = formPhotos.reduce(function (acc, formPhoto) {
  ...
  if (!categoriesForm.Guide) {
    ...
    guideMenuTotal.innerHTML = "Guide (".concat(categoriesAll, ")");
  }
  if (!categoriesForm.Quête) {
    ...
    queteMenuTotal.innerText = "Qu\xEAte (".concat(categoriesAll, ")");
  }
  if (!categoriesForm.Collection) {
    ...
    collectionMenuTotal.innerText = "Collection (".concat(categoriesAll, ")");
  }
  if (!categoriesForm.Partage) {
    ...
    partageMenuTotal.innerText = "Partage (".concat(categoriesAll, ")");
  }
  ...
  queteMenu.addEventListener("click", function (event) {
    event.stopPropagation();
    if (filter === "Quête") {
      filter = null;
      guideMenu.classList.remove("target-filter");
  ...
  collectionMenu.addEventListener("click", function (event) {
    event.stopPropagation();
  ...
  partageMenu.addEventListener("click", function (event) {
    event.stopPropagation();
    if (filter === "Partage") {
      filter = null;
      guideMenu.classList.remove("target-filter");
